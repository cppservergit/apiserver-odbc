...
CC_OBJS=env.o logger.o jwt.o httputils.o email.o odbcutil.o sql.o login.o util.o main.o

apiserver: env.o logger.o jwt.o httputils.o email.o odbcutil.o sql.o login.o util.o main.o
